...
export async function submitJob(
  ...
  (async () => {
    ...
    try {
      ...
      // cancelJob() may have flipped status to "cancelled" while we were
      // awaiting above; read through the widened type so TS doesn't narrow
      // it away (control flow can't see the concurrent mutation).
