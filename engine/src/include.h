...
#include <setjmp.h>
#include <signal.h>
#include <unistd.h>   /* write/getpid/fork/execlp/chdir under GENERIC (macOS/BSD) */
#include <sys/types.h>
#ifdef _WIN32
#include <windows.h>  /* engine's WIN32 paths (threads, console, memory stats) */
#include <process.h>  /* _spawnlp for SHELL_NODE; no sys/times.h on MinGW (V_CLOCK falls back to clock()) */
#else
#include <sys/times.h>
#endif
#include <sys/time.h>
...
#if defined(__WIN32__) && !defined(__CYGWIN__) && !defined(__MINGW32__) /* Borland-era block; MinGW uses GENERIC */
#include <windows.h>
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
